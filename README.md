...
**Data and infra:** Firebase, MongoDB, PostgreSQL  
**Tooling and DevEx:** TypeScript (strict), ESLint, Prettier, Jest, Docker, GitHub Actions, Sentry  
**Web3 and integrations:** WalletConnect, multi-chain signing flows, crypto wallets  
**State and data:** Zustand, React Query  
...
###### Open to senior / lead mobile and full-stack roles, as well as impactful contract work
